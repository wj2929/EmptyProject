$.validator.addMethod("guidnotempty", function (value, element, param) {
    return value;
});
...
jQuery.validator.addMethod("isguid", function (value, element) {
...
jQuery.validator.addMethod("shortfilenamebyjscssextneed", function (value, element) {
...
jQuery.validator.addMethod("shortfilename", function (value, element) {
