...
function GoPage(num) {
    ...
    $.ajax({
        type: "POST",
        url: "TestPaperList.aspx/GetPage",
...
function DelInfo(retVal, _refP1, _refP2) {
    yonLay(_refP1, _refP2, function (flag) {
        if (flag) {
            $.ajax({
                type: "POST",
                url: "TestPaperList.aspx/DelInfo",
                data: '{DelGuid:"' + retVal + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
...
function DelInfos(_refP1, _refP2) {
    yonLay(_refP1, _refP2, function (flag) {
        if (flag) {
            ...
            $.ajax({
                type: "POST",
                url: "TestPaperList.aspx/DelInfos",
...
function CreateTestPaper(retVal, _refP1, _refP2) {
    yonLay(_refP1, _refP2, function (flag) {
        if (flag) {
            $.ajax({
                type: "POST",
                url: "TestPaperList.aspx/CreateTestPaper",
                data: '{TestPaperId:"' + retVal + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    if (msg.d == "ok") {
