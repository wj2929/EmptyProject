...
{
    public class UserThirdLoginExtend : EntityWithGuid
    {
        public UserThirdLoginExtend()
        {
        ...
        public DateTime LastBindDateTime { get; set; }

        public int BindUserNameCount { get; set; }
        ...
        /// 第三方登录信息历史
        /// </summary>
        public virtual ICollection<UserThirdLoginHistory> UserThirdLoginHistorys { get; set; }
    }
}
